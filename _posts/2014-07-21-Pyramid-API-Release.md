...
Supported Bill Validators
  ...
  <a href="/api" target="_blank" class="list-group-item">The API documentation is available here.<img alt="javadoc_icon" src="/img/posts/javadoc_icon.png" class="pull-right"></a>
  <a href="/api/release/PTalk.jar" class="list-group-item">The API jar file is available here.<img alt="jar_icon" src="/img/posts/jar_icon.png" class="pull-right"></a>
</div>
<br>
